    ...
    <>
      ...
      <section className="bg-brand py-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-bold tracking-widest uppercase text-[#C4A265] mb-3">About Us</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-xs font-bold tracking-widest uppercase text-[#C4A265] mb-3">Our Story</p>
              <h2 className="text-3xl font-black text-brand mb-6">
                Built on a Passion for Beautiful Bathrooms
              </h2>
              <div className="space-y-4 text-[#8B7D72] leading-relaxed">
                <p>
              ...
              <div className="mt-8">
                <Link
                  href="/free-estimate"
                  className="inline-flex items-center gap-2 bg-[#C4A265] hover:bg-[#B8935A] text-white font-bold px-6 py-3 transition-colors"
                >
            ...
            <div className="bg-[#F9F7F3] aspect-[4/3] flex items-center justify-center">
              <span className="text-[#8B7D72] text-sm tracking-widest uppercase">Team Photo</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#F9F7F3]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <p className="text-xs font-bold tracking-widest uppercase text-[#C4A265] mb-3">Our Values</p>
            <h2 className="text-3xl font-black text-brand">How We Work</h2>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v) => (
              <div key={v.title} className="bg-white p-8 border border-[#EDE9E3]">
                <div className="w-8 h-1 bg-[#C4A265] mb-5" />
                <h3 className="font-bold text-brand mb-3">{v.title}</h3>
                <p className="text-sm text-[#8B7D72] leading-relaxed">{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-xs font-bold tracking-widest uppercase text-[#C4A265] mb-3">What You Can Expect</p>
      ...
      <section className="py-16 bg-brand">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/free-estimate"
              className="inline-flex items-center justify-center gap-2 bg-[#C4A265] text-white font-bold px-8 py-4"
            >
              Free Estimate <ArrowRight size={15} />
            </Link>
            <a
              href="tel:07934679117"
              className="inline-flex items-center justify-center gap-2 border border-[#2A2A2E] text-white font-bold px-8 py-4 hover:border-[#C4A265] transition-colors"
            >
