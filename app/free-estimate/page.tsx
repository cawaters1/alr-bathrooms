    ...
    <>
      <section className="bg-brand py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-bold tracking-widest uppercase text-[#C9A97A] mb-3">No Obligation</p>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.step} className="flex gap-3">
                      <div className="w-6 h-6 bg-[#C9A97A] flex items-center justify-center text-white text-xs font-bold shrink-0">
                        {item.step}
                      </div>
                      <p className="text-sm text-[#8B8FA0] leading-relaxed" dangerouslySetInnerHTML={{ __html: item.text }} />
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-white border border-[#EDEAE3] p-8">
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-[#C9A97A] font-bold text-lg mb-2 hover:underline"
                >
                  <Phone size={18} />
                  07934 679117
                </a>
                <div className="flex items-center gap-2 text-sm text-[#8B8FA0]">
              ...
              <div className="bg-white border border-[#EDEAE3] p-8">
                <div className="text-xs font-bold tracking-widest uppercase text-[#C9A97A] mb-4">
                  Our Promise
                </div>
                <div className="space-y-2.5">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-2 text-sm text-brand">
                      <CheckCircle2 size={14} className="text-[#C9A97A] shrink-0" />
                      {item}
                    </div>
                  ))}
                </div>
