    ...
    <>
      <section className="bg-brand py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-bold tracking-widest uppercase text-[#C9A97A] mb-3">Get In Touch</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-white border border-[#EDEAE3] p-8">
                ...
                <div className="space-y-4">
                  <a href="tel:07934679117" className="flex items-center gap-3 group">
                    <div className="w-9 h-9 bg-[#F8F6F2] flex items-center justify-center shrink-0">
                      <Phone size={15} className="text-[#C9A97A]" />
                    </div>
                    <div>
                      <div className="text-xs text-[#8B8FA0] uppercase tracking-widest font-bold mb-0.5">Phone</div>
                      <div className="text-sm font-bold text-brand group-hover:text-[#C9A97A] transition-colors">
                        07934 679117
                      </div>
                    </div>
                  </a>
                  <a href="mailto:info@alrbathrooms.com" className="flex items-center gap-3 group">
                    <div className="w-9 h-9 bg-[#F8F6F2] flex items-center justify-center shrink-0">
                      <Mail size={15} className="text-[#C9A97A]" />
                    </div>
                    <div>
                      <div className="text-xs text-[#8B8FA0] uppercase tracking-widest font-bold mb-0.5">Email</div>
                      <div className="text-sm font-bold text-brand group-hover:text-[#C9A97A] transition-colors break-all">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-9 h-9 bg-[#F8F6F2] flex items-center justify-center shrink-0">
                      <MapPin size={15} className="text-[#C9A97A]" />
                    </div>
                    <div>
                      <div className="text-xs text-[#8B8FA0] uppercase tracking-widest font-bold mb-0.5">Address</div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 bg-[#F8F6F2] flex items-center justify-center shrink-0">
                      <Clock size={15} className="text-[#C9A97A]" />
                    </div>
                    <div>
                      <div className="text-xs text-[#8B8FA0] uppercase tracking-widest font-bold mb-0.5">Hours</div>
              ...
              <div className="bg-brand border border-[#2A3355] p-8">
                <div className="text-xs font-bold tracking-widest uppercase text-[#C9A97A] mb-3">Free Estimates</div>
                <p className="text-sm text-[#8B8FA0] leading-relaxed mb-4">
